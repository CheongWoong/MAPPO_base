...
# Default RECIPE 'MAPPO_base' can be overridden by 'RECIPE' environment variable
RECIPE=${RECIPE:-MAPPO_base}
# Default ENV_NAME 'MAPPO_base' can be overridden by 'ENV_NAME'
